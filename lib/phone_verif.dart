            ...
            child: Form(
              key:_formKey,
                ...
                children: <Widget>[
                  ...
                  Expanded(
                                    child: Padding(
                      padding:  EdgeInsets.symmetric(horizontal: width *0.06,vertical:20.0  ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: <Widget>[
                         Text(
    ...
    return TextFormField(
      ...
      textAlign: TextAlign.right,
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: _dateTime !=null ?   intl.DateFormat.yMd().format(_dateTime)  :  "تاريخ الولادة",
    ...
    return TextFormField(
      textAlign: TextAlign.end,
                     textDirection: TextDirection.rtl,
                      ...
                      validator: (value)=>value.length<5 ?  "5 ahrof":null,
                      style: TextStyle(),
                      cursorColor: Color(0xff8DBF44),
                      decoration: InputDecoration(
                          border: OutlineInputBorder(
  ...
  TextFormField buildPhoneField() {
    return TextFormField(
      textAlign: TextAlign.end,
                      ...
                      validator: (value)=>value.length<8 ?  "adkhel 8 arkam":null,
                      cursorColor: Color(0xff8DBF44),
              ...
              child: InkWell(
                  ...
                  onTap: () {
                    ...
                    if(_formKey.currentState.validate() && _checkBoxValue)
                    {
                      ...
                      child: AlertDialog(
                         title: Text("wefA9 ala om l wahed"),
                         content: Text("wefa9 ala l korrasa"),
                         actions: <Widget>[
